...
function TodoItem({ todo, toggleTodo, deleteTodo, editTodo }) {
  ...
  return (
    <div
      className={`
        flex items-start sm:items-center gap-3 p-3 sm:p-4 rounded-xl transition-all duration-200
        ${
          todo.completed
    ...
    >
      <div className='flex items-center w-full sm:w-auto'>
        <input
          ...
          className='
            w-5 h-5 text-indigo-600 dark:text-indigo-400 rounded 
        ...
        <span
          className={`
            ml-3 sm:hidden flex-1 cursor-pointer select-none break-words transition-colors
            ${
              todo.completed
        ...
        <div className='flex gap-1 ml-auto sm:hidden'>
          ...
          <button
            ...
            className='p-1.5 rounded-lg hover:bg-red-50 dark:hover:bg-red-900/30 text-gray-500 dark:text-gray-400 hover:text-red-600 dark:hover:text-red-400 transition-colors'
            title='Delete'
          >
            <svg
              className='w-4 h-4'
      ...
      {isEditing ? (
        <div className='w-full sm:flex-1'>
          <input
            ...
            className='
              w-full px-3 py-2 border-2 border-indigo-300 dark:border-indigo-500 
              rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-200 
              dark:focus:ring-indigo-800 bg-white dark:bg-gray-700 
        ...
        <span
          className={`
            hidden sm:block flex-1 cursor-pointer select-none break-words transition-colors
